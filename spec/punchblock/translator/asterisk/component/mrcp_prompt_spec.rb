    ...
    class Asterisk
      module Component
        describe MRCPPrompt do
          ...
          describe 'Input#speech-incomplete-timeout' do
            context 'a positive number' do
              let(:input_command_opts) { { speech_incomplete_timeout: 1000 } }
            ...
            context 'unset' do
              let(:input_command_opts) { { speech_incomplete_timeout: nil } }
            ...
            context 'a negative number other than -1' do
              ...
              it "should return an error and not execute any actions" do
                subject.execute
                error = ProtocolError.new.setup 'option error', 'A speech-incomplete-timeout value must be -1 or a positive integer.'
